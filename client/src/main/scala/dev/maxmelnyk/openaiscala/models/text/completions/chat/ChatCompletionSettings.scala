...
/** [[https://platform.openai.com/docs/api-reference/chat]]
  ...
  *   that function. "none" is the default when no functions are present. "auto"
  ...
  *   Accepts a `Map` that maps tokens (specified by their token ID in the
  ...
  */
case class ChatCompletionSettings(
    model: String = Models.gpt35Turbo,
    functions: Option[Seq[Function]] = None,
